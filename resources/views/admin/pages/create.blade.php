...
$url = URL::action('App\Content\Http\Controllers\Admin\Page\Controller@store');
...
@section('content')
    ...
    <div class="card-body">
        ...
        <div class="form-group" style="box-shadow: 12px ">
        ...
        <div class="form-group">
            <label class="form-check">
                {!! Form::checkbox('show_in_navigation', 1, false) !!}
        ...
        <div class="form-group">
            <label class="form-check">
                {!! Form::checkbox('selectable_in_navigation', 1, false) !!}
        ...
        <div class="form-group">
            <label class="form-check">
                {!! Form::checkbox('show_articles_in_navigation', 1, false) !!}
