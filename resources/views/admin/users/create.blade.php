...
{!! Form::open(['url' => $url]) !!}
        ...
        <div class="form-group">
            ...
            <div class="dropdown">
            {!! Form::select('role', $roleOptions, $defaultRoleOption) !!}
            </div>
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                {!! Form::text('first_name', null, ['size' => '15', 'required']) !!}
            </div>
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                {!! Form::text('last_name', null, ['class' => 'c-inputField', 'size' => '20', 'required']) !!}
            </div>
